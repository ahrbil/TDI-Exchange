...
const TermsOfService = () => (
  <div className="markdown">
    ...
    <p>
      ...
      <a href="https://tdi-exchange.now.sh">https://tdi-exchange.now.sh</a>, you
    ...
    <ol type="a">
      <li>
        ...
        (information or software) on tdi-exchange's website for personal,
      ...
      <li>
        ...
        restrictions and may be terminated by tdi-exchange at any time. Upon
    ...
    <ol type="a">
      <li>
        The materials on tdi-exchange's website are provided on an 'as is'
        basis. tdi-exchange makes no warranties, expressed or implied, and
      ...
      <li>
        Further, tdi-exchange does not warrant or make any representations
    ...
    <h3>4. Limitations</h3>
    <p>
      In no event shall tdi-exchange or its suppliers be liable for any damages
      ...
      materials on tdi-exchange's website, even if tdi-exchange or a
      tdi-exchange authorized representative has been notified orally or in
    ...
    <p>
      The materials appearing on tdi-exchange's website could include technical,
      typographical, or photographic errors. tdi-exchange does not warrant that
      any of the materials on its website are accurate, complete or current.
      tdi-exchange may make changes to the materials contained on its website at
      any time without notice. However tdi-exchange does not make any commitment
      to update the materials.
    </p>
    <h3>6. Links</h3>
    <p>
      tdi-exchange has not reviewed all of the sites linked to its website and
      is not responsible for the contents of any such linked site. The inclusion
      of any link does not imply endorsement by tdi-exchange of the site. Use of
      any such linked website is at the user's own risk.
    </p>
    <h3>7. Modifications</h3>
    <p>
      tdi-exchange may revise these terms of service for its website at any time
    ...
    <p>
      ...
      with the laws of morocco and you irrevocably submit to the exclusive
